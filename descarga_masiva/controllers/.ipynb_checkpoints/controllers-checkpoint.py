...
# class Testingodoo(http.Controller):
#     @http.route('/testingodoo/testingodoo/', auth='public')
#     def index(self, **kw):
#         return "Hello, world"

#     @http.route('/testingodoo/testingodoo/objects/', auth='public')
#     def list(self, **kw):
#         return http.request.render('testingodoo.listing', {
#             'root': '/testingodoo/testingodoo',
#             'objects': http.request.env['testingodoo.testingodoo'].search([]),
#         })

#     @http.route('/testingodoo/testingodoo/objects/<model("testingodoo.testingodoo"):obj>/', auth='public')
#     def object(self, obj, **kw):
#         return http.request.render('testingodoo.object', {
#             'object': obj
#         })
